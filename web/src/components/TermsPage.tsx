  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: "Nuestro sitio web puede utilizar cookies y tecnologÃ­as similares para mejorar la experiencia del usuario, analizar el trÃ¡fico del sitio y personalizar contenido. El usuario puede configurar su navegador para rechazar cookies, aunque esto puede afectar la funcionalidad del sitio. Para mÃ¡s informaciÃ³n, consulte nuestra PolÃ­tica de Cookies."
      },
      {
    ...
    content: [
      {
        ...
        text: "Las cookies son pequeÃ±os archivos de texto que se almacenan en su dispositivo (computadora, tablet o telÃ©fono mÃ³vil) cuando visita un sitio web. Las cookies permiten que el sitio web reconozca su dispositivo, recuerde sus preferencias y mejore su experiencia de navegaciÃ³n. Las cookies pueden ser 'propias' (configuradas por DOOQ) o 'de terceros' (configuradas por servicios externos que utilizamos)."
      },
      {
        id: "tipos-cookies",
      ...
      },
      {
        ...
        text: "Puede controlar y gestionar las cookies mediante la configuraciÃ³n de su navegador. La mayorÃ­a de los navegadores web le permiten: (a) ver quÃ© cookies tiene almacenadas; (b) eliminar cookies individualmente o todas a la vez; (c) bloquear cookies de terceros; (d) bloquear cookies de sitios especÃ­ficos; (e) bloquear todas las cookies. Tenga en cuenta que si desactiva las cookies, algunas funcionalidades del sitio pueden no funcionar correctamente."
      },
      {
        id: "actualizaciones-cookies",
        title: "4. Actualizaciones de la PolÃ­tica",
        text: "DOOQ se reserva el derecho de modificar esta PolÃ­tica de Cookies en cualquier momento. Los cambios entrarÃ¡n en vigor inmediatamente despuÃ©s de su publicaciÃ³n en el sitio web. Se recomienda revisar periÃ³dicamente esta pÃ¡gina para mantenerse informado sobre el uso de cookies."
      }
    ]
  },
  {
    ...
    content: [
      {
        ...
        text: "DOOQ Technology Holding es una marca comercial registrada en Colombia. RazÃ³n social: DOOQ Technology Holding S.A.S. NIT: [Pendiente de registro]. DirecciÃ³n de notificaciones judiciales: [Pendiente de registro - BogotÃ¡ D.C., Colombia]. Correo electrÃ³nico: contacto@dooq.dev. TelÃ©fono: +57 311 889 3722."
      },
      {
        id: "registro",
        title: "2. Inscripciones Registrales",
        text: "DOOQ Technology Holding y sus marcas asociadas se encuentran en proceso de registro ante la Superintendencia de Industria y Comercio (SIC) de Colombia. El uso de las marcas en este sitio web no constituye declaraciÃ³n alguna sobre su estado de registro o protecciÃ³n legal."
      },
      {
        id: "exactitud-info",
        title: "3. Exactitud de la InformaciÃ³n",
        text: "DOOQ realiza esfuerzos razonables para asegurar que la informaciÃ³n publicada en este sitio web sea precisa y estÃ© actualizada. Sin embargo, no garantiza la exactitud, integridad o actualidad de la informaciÃ³n. Los precios, especificaciones tÃ©cnicas y disponibilidad de servicios estÃ¡n sujetos a cambios sin previo aviso. La informaciÃ³n contenida en este sitio web tiene carÃ¡cter informativo y no constituye oferta vinculante."
      },
      {
        id: "enlaces-externos",
      ...
      <div className="section-container relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-800 text-slate-300 font-mono text-xs font-semibold uppercase tracking-wider mb-4 border border-slate-700">
            ...
            <span>DocumentaciÃ³n Legal</span>
          </div>
          <h2 className="font-heading font-extrabold text-3xl sm:text-4xl text-white tracking-tight mb-3">
            TÃ©rminos, Privacidad y Avisos Legales
          </h2>
          <p className="text-slate-400 text-base sm:text-lg">
            DocumentaciÃ³n legal completa de DOOQ Technology Holding. Lea detenidamente cada secciÃ³n.
          </p>
        </motion.div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-heading font-bold text-sm text-white">
                        Â¿Tiene preguntas sobre estos tÃ©rminos?
                      </p>
